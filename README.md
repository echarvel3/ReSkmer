...
------------
ReSkmer is an update to the Skmer software which utlizes a genome's _k_-mer repeat spectrum to obtain more accurate distances by modeling repeat's effect on the intersection of _k_-mer sets.
#### Input Spectrum
